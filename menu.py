...
class MainWindow(QMainWindow):
    ...
    def timer(self):
        ...
        while (cap.isOpened()):
            ...
            cv2.putText(frame, str("-> Always use an exercise mat while exercising"), (90, 400), cv2.FONT_HERSHEY_PLAIN, 3.6, (0,255,0), 3)
            cv2.putText(frame, str("-> Place your camera 2-3 meters away from yourself"), (90, 500), cv2.FONT_HERSHEY_PLAIN, 3.6, (0,255,0), 3)
            cv2.putText(frame, str("-> Set the camera angle in such a way that your whole"), (90, 600), cv2.FONT_HERSHEY_PLAIN, 3.6, (0,255,0), 3)
            cv2.putText(frame, str("    body is captured"), (90, 700), cv2.FONT_HERSHEY_PLAIN, 3.6, (0,255,0), 3)
            cv2.putText(frame, str("-> Refer demo videos once before you start exercising"), (90, 800), cv2.FONT_HERSHEY_PLAIN, 3.6, (0,255,0), 3)
            if ret == True:
